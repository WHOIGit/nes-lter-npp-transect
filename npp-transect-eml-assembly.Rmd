...
new_discrete_1 <- read_csv("C:/Users/wanglab/Downloads/npp_discrete_version1 (1).csv", show_col_types = FALSE) 
...
# every npp_rate value is slightly different

# Integrated
npp_integrated_1 <- read_csv(paste0('npp_integrated_version1.csv'), show_col_types = FALSE) 
new_integrated_1 <- read_csv("C:/Users/wanglab/Downloads/npp_integrated_version1 (1).csv", show_col_types = FALSE) 
...
# stations designated differently, numeral only in original, L-numeral in new
