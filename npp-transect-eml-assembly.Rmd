...
#version <- 'v3'
#<<<<<<< HEAD
version <- 'v4' #version 4 corrections to integrated data and one flag change in discrete 

#>>>>>>> ef7290c2034f7fa23a67aff1cb9b4bc52342a9ca
...
write.csv(npp_integrated, paste0("nes-lter-npp-transect-integrated-", version, ".csv"), row.names = FALSE)
}
...
if (version == 'v4') {
  ...
  datatables <- c('nes-lter-npp-transect-discrete-v4.csv', 'nes-lter-npp-transect-integrated-v4.csv')
  other <- c('raw_npp_data.zip','HOBO_data.zip', 'light_data.zip')
  parent_project <- 'parent_project_LTER_RAPID.txt'
}
