...
"filter_size", "vol_filt_L", "POC_ug_L")
poc <- poc[, headers]
...
ggplot(poc, aes(x= date_time_utc, y = POC_ug_L, color = depth))+ geom_point()
ggsave("poc-by-date-depth.png")
ggplot(poc, aes(x= date_time_utc, y = -depth, color = POC_ug_L))+ geom_point()
ggsave("depth-by-date-poc.png")

# view maps
map_locs(poc, colorvar = "POC_ug_L", region = "transect")
