...
npp_discrete$alternate_sample_ID <- as.factor(npp_discrete$alternate_sample_ID)
...
make_eml(here(),
         ...
         other.entity.description = c('Raw data used to generate product data tables', 'Raw incubation tank water temperature data'),
