...
write.csv(npp_discrete, "nes-lter-npp-transect-discrete-v3.csv", row.names = FALSE)
write.csv(npp_integrated, "nes-lter-npp-transect-integrated-v3.csv", row.names = FALSE)
}
...
if (version == 'v3') {
  ...
  datatables <- c('nes-lter-npp-transect-discrete-v3.csv', 'nes-lter-npp-transect-integrated-v3.csv')
  other <- c('raw_npp_data.zip','HOBO_data.zip', 'light_data.zip')
  parent_project <- 'parent_project_LTER_RAPID.txt'
}
